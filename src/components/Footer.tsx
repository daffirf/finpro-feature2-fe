        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/search" className="text-gray-400 hover:text-white transition-colors">Cari Penginapan</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/help" className="text-gray-400 hover:text-white transition-colors">Pusat Bantuan</a></li>
