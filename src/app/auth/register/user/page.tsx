              ...
              <CardContent className="pt-12 pb-12 text-center">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 text-left">
                  ...
                  <ol className="text-sm text-gray-600 mt-2 space-y-1 list-decimal list-inside">
                    ...
                    <li>Login dan mulai memesan penginapan</li>
                  </ol>
                </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="shadow-xl border-0">
            <CardHeader className="space-y-4 pb-6">
              ...
              <div className="text-center space-y-2">
                ...
                <CardDescription className="text-base">
                  🏠 Temukan dan pesan penginapan terbaik untuk Anda!
                </CardDescription>
              </div>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              {/* Google OAuth */}
              <GoogleOAuthButton type="register" callbackUrl="/landing" />
            ...
            <div className="bg-teal-50 border border-teal-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 text-center">
                <strong>🏠 Sebagai Guest, Anda bisa:</strong>
              </p>
              <ul className="text-xs text-gray-600 mt-2 space-y-1 list-disc list-inside text-center">
                <li>Mencari dan membandingkan penginapan</li>
                <li>Memesan penginapan dengan mudah</li>
                <li>Memberikan review dan rating</li>
                <li>Mengelola riwayat booking Anda</li>
              </ul>
            </div>
